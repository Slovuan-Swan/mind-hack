...
2. **brain-calc** — калькулятор (сложение, вычитание, умножение).
3. **brain-gcd** — нахождение наибольшего общего делителя двух чисел.
...
```bash
git clone https://github.com/Slovuan-Swan/mind-hack.git
cd mind-hack
npm install
npm link
```
...
После установки вы можете запустить любую игру прямо из терминала:
